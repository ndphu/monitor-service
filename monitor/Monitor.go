...
func processRule(r model.Rule) {
	...
	if response, err := recognizeBulk(pics); err != nil {
...
func recognizeBulk(images [][]byte) (*BulkRecognizeResponse, error) {
	...
	rpcResponseTopic := "/3ml/rpc/recognizeFacesBulk/response/" + reqId
